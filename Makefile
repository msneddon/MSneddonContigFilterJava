SERVICE = msneddoncontigfilterjava
SERVICE_CAPS = MSneddonContigFilterJava
SPEC_FILE = MSneddonContigFilterJava.spec
URL = https://kbase.us/services/msneddoncontigfilterjava
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
