package msneddoncontigfilterjava.test;
...
import msneddoncontigfilterjava.FilterContigsParams;
import msneddoncontigfilterjava.FilterContigsResults;
import msneddoncontigfilterjava.MSneddonContigFilterJavaServer;
...
public class MSneddonContigFilterJavaServerTest {
    private static AuthToken token = null;
    private static Map<String, String> config = null;
    private static WorkspaceClient wsClient = null;
    private static String wsName = null;
    private static MSneddonContigFilterJavaServer impl = null;
    ...
    public static void init() throws Exception {
        ...
        config = ini.get("MSneddonContigFilterJava");
        ...
        impl = new MSneddonContigFilterJavaServer();
    }
    
    private static String getWsName() throws Exception {
        if (wsName == null) {
            long suffix = System.currentTimeMillis();
            wsName = "test_MSneddonContigFilterJava_" + suffix;
    ...
    private static RpcContext getContext() {
        return new RpcContext().withProvenance(Arrays.asList(new ProvenanceAction()
            .withService("MSneddonContigFilterJava").withMethod("please_never_use_it_in_production")
